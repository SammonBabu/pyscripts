...
params = {
    "q": "http://atomlabs.ca/ logo", # search query
...
def get_original_images(url):
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.5060.114 Safari/537.36"
    }

    params = {
        "q": ""+url+" logo",          # search query
        "tbm": "isch",                # image results
        "hl": "en",                   # language of the search
        "gl": "us",                   # country where search comes from
        "ijn": "0"                    # page number
    ...
    print("matched_google_image_data",matched_google_image_data)
...
# filename = open('../test_csv/test_cases_logo_error_cases.csv', 'r')
# file = csv.DictReader(filename)
# urls = []
# for col in file:
# 	urls.append(col['Web Url'])

src = get_original_images("hobby")
print(src)

# for x in range(0,5):
#     print(urls[x])
#     src = get_original_images(urls[x])
#     print(src[0]["original"])